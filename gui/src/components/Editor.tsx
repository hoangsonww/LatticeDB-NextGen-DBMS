...
export default function SqlEditor() {
  const { sql, setSql, run, darkMode, favorites, addToFavorites, removeFromFavorites } = useStore()
  ...
  return (
    <div className={`card transition-all duration-300 flex flex-col overflow-hidden ${
      isFullscreen
      ...
      <div className={`flex items-center justify-between px-4 py-2 border-b transition-colors duration-300 ${
        ...
        <div className="flex items-center gap-2">
          {sql.trim() && (
            ...
            >
              {isFavorited ? <Star size={16} fill="currentColor" /> : <Star size={16} />}
            </button>
          )}
