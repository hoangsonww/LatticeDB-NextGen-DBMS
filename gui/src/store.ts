...
const mockTables: TableSchema[] = [
  {
    ...
    columns: [
      ...
      { name: 'profile_vector', type: 'VECTOR(4)', nullable: true, primary: false }
    ],
    rowCount: 1247
  },
  {
    ...
    columns: [
      ...
      { name: 'order_date', type: 'TIMESTAMP', nullable: false, primary: false }
    ],
    rowCount: 3891
  },
  {
    ...
    columns: [
      ...
      { name: 'embedding', type: 'VECTOR(768)', nullable: true, primary: false }
    ],
    rowCount: 567
  },
  {
    ...
    columns: [
      ...
      { name: 'event_name', type: 'VARCHAR(100)', nullable: false, primary: false },
...
const mockUsers = [
  [1, 'Alice Smith', 'alice.smith@example.com', 30, '2024-01-15 10:30:00', '[0.12, 0.34, 0.56, 0.78]'],
  [2, 'Bob Johnson', 'bob.johnson@example.com', 25, '2024-01-16 14:22:15', '[0.23, 0.45, 0.67, 0.89]'],
  [3, 'Charlie Brown', 'charlie.brown@example.com', 35, '2024-01-17 09:15:30', '[0.34, 0.56, 0.78, 0.12]'],
  [4, 'Diana Prince', 'diana.prince@example.com', 28, '2024-01-18 16:45:22', '[0.45, 0.67, 0.89, 0.23]'],
  [5, 'Eve Adams', 'eve.adams@example.com', 32, '2024-01-19 11:20:45', '[0.56, 0.78, 0.12, 0.34]'],
  [6, 'Frank Miller', 'frank.miller@example.com', 41, '2024-01-20 08:30:15', '[0.67, 0.89, 0.23, 0.45]'],
  [7, 'Grace Lee', 'grace.lee@example.com', 29, '2024-01-21 13:45:30', '[0.78, 0.12, 0.34, 0.56]'],
  [8, 'Henry Wilson', 'henry.wilson@example.com', 33, '2024-01-22 10:15:45', '[0.89, 0.23, 0.45, 0.67]'],
  [9, 'Ivy Chen', 'ivy.chen@example.com', 27, '2024-01-23 15:30:22', '[0.11, 0.33, 0.55, 0.77]'],
  [10, 'Jack Davis', 'jack.davis@example.com', 38, '2024-01-24 09:45:15', '[0.22, 0.44, 0.66, 0.88]'],
  [11, 'Kate Moore', 'kate.moore@example.com', 31, '2024-01-25 12:20:30', '[0.33, 0.55, 0.77, 0.11]'],
  [12, 'Liam Taylor', 'liam.taylor@example.com', 26, '2024-01-26 14:35:45', '[0.44, 0.66, 0.88, 0.22]'],
  [13, 'Mia Anderson', 'mia.anderson@example.com', 34, '2024-01-27 11:10:20', '[0.55, 0.77, 0.11, 0.33]'],
  [14, 'Noah Garcia', 'noah.garcia@example.com', 29, '2024-01-28 16:25:35', '[0.66, 0.88, 0.22, 0.44]'],
  [15, 'Olivia Martinez', 'olivia.martinez@example.com', 32, '2024-01-29 10:40:50', '[0.77, 0.11, 0.33, 0.55]'],
  [16, 'Paul Rodriguez', 'paul.rodriguez@example.com', 36, '2024-01-30 13:15:25', '[0.88, 0.22, 0.44, 0.66]'],
  [17, 'Quinn Thompson', 'quinn.thompson@example.com', 28, '2024-02-01 09:30:40', '[0.19, 0.37, 0.51, 0.73]'],
  [18, 'Ruby White', 'ruby.white@example.com', 31, '2024-02-02 15:45:15', '[0.28, 0.46, 0.62, 0.84]'],
  [19, 'Sam Harris', 'sam.harris@example.com', 37, '2024-02-03 12:00:30', '[0.37, 0.55, 0.73, 0.19]'],
  [20, 'Tina Clark', 'tina.clark@example.com', 25, '2024-02-04 14:20:45', '[0.46, 0.64, 0.82, 0.28]']
]

const mockOrders = [
  [1, 1, 299.99, 'completed', '2024-01-20 14:30:15'],
  [2, 2, 149.50, 'pending', '2024-01-21 10:15:30'],
  [3, 3, 89.99, 'processing', '2024-01-21 16:45:20'],
  [4, 4, 199.99, 'completed', '2024-01-22 09:30:45'],
  [5, 1, 75.50, 'cancelled', '2024-01-22 11:20:15'],
  [6, 5, 450.00, 'completed', '2024-01-23 13:45:30'],
  ...
  [11, 10, 67.50, 'completed', '2024-01-25 14:20:25'],
  ...
  [15, 13, 159.50, 'pending', '2024-01-27 13:00:45'],
  ...
  [19, 16, 89.50, 'pending', '2024-01-29 14:30:25'],
...
const mockEvents = [
  [1, 'page_view', 1, '{"page": "/dashboard", "referrer": "google.com"}', '2024-02-01 10:15:30'],
  [2, 'button_click', 1, '{"button_id": "purchase", "product_id": 15}', '2024-02-01 10:16:45'],
  [3, 'page_view', 2, '{"page": "/products", "category": "electronics"}', '2024-02-01 10:20:15'],
  [4, 'search', 3, '{"query": "wireless headphones", "results": 12}', '2024-02-01 10:25:30'],
  [5, 'add_to_cart', 3, '{"product_id": 1, "quantity": 1, "price": 129.99}', '2024-02-01 10:26:45'],
  [6, 'purchase', 4, '{"order_id": 16, "total": 379.99, "items": 2}', '2024-02-01 11:30:15'],
  [7, 'page_view', 5, '{"page": "/profile", "section": "settings"}', '2024-02-01 11:45:20'],
  [8, 'form_submit', 6, '{"form": "newsletter", "email": "frank.miller@example.com"}', '2024-02-01 12:15:35'],
  [9, 'video_play', 7, '{"video_id": "product_demo_1", "duration": 120}', '2024-02-01 13:20:45'],
  [10, 'download', 8, '{"file": "user_manual.pdf", "product_id": 4}', '2024-02-01 14:30:20'],
  [11, 'page_view', 9, '{"page": "/checkout", "step": "payment"}', '2024-02-01 15:45:15'],
  [12, 'error', 10, '{"error": "payment_failed", "code": "CARD_DECLINED"}', '2024-02-01 15:46:30'],
  [13, 'logout', 11, '{"session_duration": 3600, "pages_viewed": 8}', '2024-02-01 16:20:45'],
  [14, 'login', 12, '{"method": "google_oauth", "new_user": false}', '2024-02-01 17:15:20'],
  [15, 'search', 13, '{"query": "office chair", "results": 5, "filter": "price_asc"}', '2024-02-01 18:30:35'],
  [16, 'page_view', 14, '{"page": "/reviews", "product_id": 4}', '2024-02-01 19:45:50'],
  [17, 'review_submit', 14, '{"product_id": 4, "rating": 5, "text_length": 234}', '2024-02-01 19:50:15'],
  [18, 'share', 15, '{"platform": "twitter", "content": "product_link", "product_id": 2}', '2024-02-01 20:15:30'],
  [19, 'wishlist_add', 16, '{"product_id": 11, "category": "electronics"}', '2024-02-01 21:20:45'],
  [20, 'chat_start', 17, '{"support_topic": "shipping", "wait_time": 45}', '2024-02-01 22:30:20']
]
...
const mockResults: Record<string, QueryResult> = {
  ...
  'SELECT o.*, u.name FROM orders o JOIN users u ON o.user_id = u.id WHERE o.status = \'pending\'': {
    ok: true,
    message: '5 rows returned',
    headers: ['id', 'user_id', 'total_amount', 'status', 'order_date', 'name'],
    rows: [
      [2, 2, 149.50, 'pending', '2024-01-21 10:15:30', 'Bob Johnson'],
      [7, 6, 32.99, 'pending', '2024-01-23 15:10:45', 'Frank Miller'],
      [10, 9, 299.99, 'pending', '2024-01-25 10:55:50', 'Ivy Chen'],
      [15, 13, 159.50, 'pending', '2024-01-27 13:00:45', 'Mia Anderson'],
      [19, 16, 89.50, 'pending', '2024-01-29 14:30:25', 'Paul Rodriguez']
    ]
  },
...
export const useStore = create<State>()(
  ...
  history: [
    ...
    },
    {
      ...
      result: mockResults['SELECT status, COUNT(*) as count FROM orders GROUP BY status']
    }
  ],
  dpEpsilon: 1.0,
  txAsOf: undefined,
  ...
  run: async (sql?: string) => {
    ...
    const payload = { sql: querySQL + (state.dpEpsilon !== 1.0 ? `\nSET DP_EPSILON = ${state.dpEpsilon};` : "") }

    set({ executing: true })

    // Simulate network delay for better UX
    await new Promise(resolve => setTimeout(resolve, state.mockMode ? 500 : 100))
    ...
    try {
      ...
      set(s => ({
        result,
        history: [{ ts: Date.now(), sql: querySQL, result }, ...s.history].slice(0, 100)
      }))
    } catch (e: any) {
      const errorResult = {
        ok: false,
      ...
      set(s => ({
        result: errorResult,
        history: [{ ts: Date.now(), sql: querySQL, result: errorResult }, ...s.history]
      }))
    } finally {
      set({ executing: false })
    }
  ...
  addToFavorites: (sql) => set(s => ({
    favorites: [...s.favorites.filter(f => f !== sql), sql].slice(-10)
  })),
  removeFromFavorites: (sql) => set(s => ({
