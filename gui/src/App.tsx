...
export default function App() {
  const { darkMode, mockMode } = useStore(s => ({ darkMode: s.darkMode, mockMode: s.mockMode }))
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <footer className={`text-center text-xs py-6 border-t transition-colors duration-300 ${
        darkMode
