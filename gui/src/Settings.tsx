...
export default function Settings() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-black text-gray-100' : 'bg-white text-gray-900'}`}>
          ...
          <section>
            ...
            <div className="py-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className={`ml-4 px-3 py-1 rounded font-mono text-lg font-bold ${
          ...
          <section>
            ...
            <div className="py-4">
              ...
              <p className={`mb-6 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                A modern database management interface with support for temporal queries,
                differential privacy, and vector operations. Built for developers who need
                powerful database tools with a clean, intuitive interface.
              </p>
              <div className={`text-sm ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
                © 2024 LatticeDB. Built with React, TypeScript, Vite, and Tailwind CSS.
              </div>
            </div>
          </section>
        </div>
