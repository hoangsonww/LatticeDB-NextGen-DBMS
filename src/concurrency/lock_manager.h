...
public:
    LockRequest(txn_id_t txn_id, LockMode lock_mode, table_oid_t table_oid)
        : txn_id_(txn_id), lock_mode_(lock_mode), table_oid_(table_oid), granted_(false) {}

    LockRequest(txn_id_t txn_id, LockMode lock_mode, table_oid_t table_oid, RID rid)
        : txn_id_(txn_id), lock_mode_(lock_mode), table_oid_(table_oid), rid_(rid), granted_(false) {}
...
private:
    ...
    bool dfs(txn_id_t start_txn_id, txn_id_t current_txn_id,
