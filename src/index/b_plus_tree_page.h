...
public:
    ...
    bool is_internal_page() const { return page_type_ == IndexPageType::INTERNAL_PAGE; }
    bool is_root_page() const { return parent_page_id_ == INVALID_PAGE_ID; }
    ...
    page_id_t get_parent_page_id() const { return parent_page_id_; }
...
public:
    ...
    const MappingType& get_item_at(int index) const { return array_[index]; }
...
public:
    ...
    void move_all_to(BPlusTreeInternalPage* recipient, const KeyType& middle_key, BufferPoolManager* buffer_pool_manager);
