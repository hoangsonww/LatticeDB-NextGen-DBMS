...
public:
    ...
    CompressionType get_type() const override { return CompressionType::RLE; }
...
public:
    ...
    CompressionType get_type() const override { return CompressionType::DICTIONARY; }
    bool is_suitable_for_data(const uint8_t* data, size_t size) const override;
    double estimate_compression_ratio(const uint8_t* data, size_t size) const override;

    void clear_dictionary();
    size_t get_dictionary_size() const { return decode_dictionary_.size(); }
...
public:
    ...
    CompressionType get_type() const override { return CompressionType::DELTA; }
    bool is_suitable_for_data(const uint8_t* data, size_t size) const override;
    double estimate_compression_ratio(const uint8_t* data, size_t size) const override;
...
public:
    ...
    CompressionType get_type() const override { return CompressionType::BIT_PACKING; }
    bool is_suitable_for_data(const uint8_t* data, size_t size) const override;
    double estimate_compression_ratio(const uint8_t* data, size_t size) const override;
...
private:
    ...
    double benchmark_algorithm_speed(CompressionType type, const uint8_t* sample_data, size_t size) const;
    ...
    void update_statistics(CompressionType type, size_t original_size,
